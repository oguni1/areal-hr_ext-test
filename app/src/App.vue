  ...
  <div id="app">
    <nav class="nav-bar">
      <ul>
        ...
        <li><router-link to="/passports">Passports</router-link></li>
        <li><router-link to="/registrations">Registrations</router-link></li>
        <li><router-link to="/operation-history">Operation History</router-link></li>
