    ...
    <div>
      ...
      <div v-for="user in users" :key="user.id">
        ...
        <template v-if="editingUser && editingUser.id === user.id">
          ...
          <input v-model="editingUser.password" type="text" placeholder="Пароль">
...
export default {
  ...
  methods: {
    ...
    async addUser() {
      if (!this.newUser.surname || !this.newUser.name || !this.newUser.login || 
    ...
    async updateUser() {
      if (!this.editingUser.surname || !this.editingUser.name || !this.editingUser.login || 
